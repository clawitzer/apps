...
The values set in the function setrun_alt are then written out to data files
...
#------------------------------
def setrun_alt(claw_pkg='geoclaw'):
#------------------------------
    ...
    INPUT:
        claw_pkg expected to be "geoclaw" for this setrun_alt.
